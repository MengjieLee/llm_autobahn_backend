...
def create_pipeline_job(
    ...
    env_vars = [
        ...
        {"name": "TSDB_ENABLED", "value": os.environ.get("TSDB_ENABLED", "true")},
        {"name": "TSDB_ACCESS_KEY_ID", "value": os.environ.get("TSDB_ACCESS_KEY_ID", "")},
        {"name": "TSDB_SECRET_ACCESS_KEY", "value": os.environ.get("TSDB_SECRET_ACCESS_KEY", "")},
